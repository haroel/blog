	...
	public class TestPageUI extends Dialog {
		protected static var uiXML:XML =
			<Dialog width="600" height="400">
			  ...
			  <TextArea text="TextArea\nTextArea\nTextArea\nTextArea\nTextArea\nTextArea\nTextArea" skin="png.comp.textarea" x="45" y="297" width="125" height="103" vScrollBarSkin="png.comp.vscroll" hScrollBarSkin="png.comp.hscroll" sizeGrid="2,2,2,2" margin="1,1,1,1"/>
			  <VSlider skin="png.comp.vslider" x="195" y="45"/>
			  <Panel x="255" y="51" vScrollBarSkin="png.comp.vscroll" hScrollBarSkin="png.comp.hscroll" width="129" height="204">
			  ...
			  <Clip skin="png.comp.clip_num" x="253" y="335" clipX="10" autoPlay="false"/>
			  <LinkButton label="label" x="7" y="183"/>
			  <Label text="label" x="6" y="255" width="220" height="60" stroke="0xff33"/>
			</Dialog>;
